...
$username = $_POST['create_name_teacher'];
$password = $_POST['create_password_teacher'];


//Setting up querry to insert data into database to create a student account 
$sql_expr_str1 = "INSERT INTO teacher VALUES('$username', '$password')";
$result1 = mysqli_query($dbc, $sql_expr_str1);


//Assinging message to show if querry was successful.
if($result1){
$info = "Congratulations you have created your account, get ready to teach!";
?> 
<?php 
}else{
